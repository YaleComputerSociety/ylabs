...
- `canonicalResearchHomeResolver.ts` - lets NIH and NSF grant sources enrich one existing official research home for a matched PI. It fails closed when no official home or multiple official homes exist, and excludes archived or grant-only synthetic shells.
