...
async function buildReferenceIntegrity(
  ...
  const audits: Array<Promise<ReferenceAuditInput>> = [
    ...
    referenceAudit(
      'research_entities.primaryDepartmentId',
      'research_entities',
      'primaryDepartmentId',
      'departments',
      false,
    ...
    referenceAudit(
      'research_entities.departmentIds',
      'research_entities',
      'departmentIds',
      'departments',
      false,
    ...
    referenceAudit(
      'research_entities.researchAreaIds',
      'research_entities',
      'researchAreaIds',
      'research_areas',
      false,
    ...
    referenceAudit(
      'research_entities.claimedByUserId',
      'research_entities',
      'claimedByUserId',
      'users',
      false,
    ...
    referenceAudit(
      'access_signals.researchEntityId',
      'access_signals',
      'researchEntityId',
      'research_entities',
      true,
