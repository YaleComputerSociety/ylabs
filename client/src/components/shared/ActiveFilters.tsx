        ...
        {hasChips && (
          <div className="flex flex-wrap items-center gap-2 border-t border-[var(--yr-line)] pb-2 pt-1.5">
            ...
            {hasAnyFilter && (
              <button
                onClick={onClearAll}
                className="inline-flex min-h-[44px] items-center gap-1 rounded-md px-2 text-xs text-gray-500 transition-colors hover:text-gray-700 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-200"
              >
