...
const BrowseListItem = React.memo(({ item, isFavorite, onToggleFavorite, onOpenModal, onAdminEdit }: BrowseListItemProps) => {
          ...
          <div className="flex items-center gap-1">
            {hasPrerequisites && (
              <div className="relative group/tip">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#9ca3af" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="hover:stroke-amber-600 transition-colors">
