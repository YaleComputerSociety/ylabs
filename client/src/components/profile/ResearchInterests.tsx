...
const ResearchInterests = ({ interests, topics }: ResearchInterestsProps) => {
  ...
  if (!hasInterests && !hasTopics) {
    return <p className="text-gray-500 text-sm py-8 text-center">No research interests available.</p>;
  }
  ...
  return (
    <div className="space-y-6">
      {hasTopics && (
        <section>
          <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Research Topics</h3>
      ...
      {hasInterests && (
        <section>
          <h3 className="text-xs font-semibold text-gray-400 uppercase tracking-wider mb-3">Research Interests</h3>
          <div className="flex flex-wrap gap-2">
