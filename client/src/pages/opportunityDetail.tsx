          ...
          <article className="lg:col-span-2 space-y-8">
            <header className="yr-panel rounded-md p-5">
              <div className="flex flex-wrap gap-2 mb-3">
                ...
                {opportunity.term && (
                  <span className="yr-pill min-h-0 rounded px-2 py-1">{opportunity.term}</span>
                )}
              ...
              <Link to={researchLink} className="yr-link inline-flex mt-3 text-base font-semibold">
                {researchDisplayName}
              </Link>
            ...
            <section>
              <h2 className="yr-kicker mb-3">Best Next Step</h2>
            ...
            {(opportunity.eligibility || compensation) && (
              <section>
                <h2 className="yr-kicker mb-3">Eligibility and Compensation</h2>
            ...
            <section>
              <h2 className="yr-kicker mb-3">Evidence</h2>
              <div className="yr-card rounded-md p-4">
                {evidence.length > 0 ? (
            ...
            <div className="yr-panel lg:sticky lg:top-8 rounded-md p-5">
              ...
              <dl>
                ...
                <DetailField
                  ...
                  value={labelize(pathway?.evidenceStrength)}
                />
              ...
              {sourceUrls.length > 0 && (
                <div className="border-t border-[var(--yr-line)] pt-4 mt-1">
                  <h3 className="yr-kicker">Sources</h3>
