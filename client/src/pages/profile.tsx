...
const Profile = () => {
  ...
  const [state, dispatch] = useReducer(profilePageReducer, undefined, () =>
    ...
    return (
      <div className="yr-page flex min-h-[calc(100vh-8rem)] items-center justify-center px-4 py-16">
        <div className="yr-panel max-w-md rounded-md p-6 text-center">
          ...
          <h1 className="text-2xl font-semibold text-slate-950">{error || 'Profile not found'}</h1>
          <p className="mt-2 text-sm leading-relaxed text-slate-600">
            The faculty member you're looking for may not have a profile yet.
          </p>
          <Link
            to="/research"
            className="mt-6 inline-flex min-h-[44px] items-center justify-center rounded-md bg-[var(--yr-blue)] px-4 py-2 text-sm font-semibold text-white hover:bg-brand-navy focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-200"
          >
            Explore Research
          </Link>
        </div>
  ...
  return (
    <div className="yr-page w-full">
      <div className="mx-auto max-w-5xl px-4 py-8">
        ...
        <div className="mt-6">
          {activeTab === 'bio' && (
            <div id="profile-bio-panel" role="tabpanel" aria-labelledby="profile-bio-tab">
              {bioText ? (
                ...
                <section>
                  ...
                  <div className="space-y-3">
                    {(profile.researchEntities || []).map((entity) => {
                      ...
                      const description = sanitizeResearchEntityCopy(
          ...
          {activeTab === 'courses' && netid && (
            <div id="profile-courses-panel" role="tabpanel" aria-labelledby="profile-courses-tab">
              <CourseTableSection
                netid={netid}
