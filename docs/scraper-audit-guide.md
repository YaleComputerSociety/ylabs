...
| `yale-directory`                   | Authoritative Yale appointment/profile metadata                                                                                       | `user`                                                                 | `researchers`                                                                                        | Membership/profile context only. Not access evidence.                                                                                                                                               | Depends on Yalies/API configuration. Good for improving person matching.                                                                                                                                                                                                                                                                                                                                                                                                                                    |
