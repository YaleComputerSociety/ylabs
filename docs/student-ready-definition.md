...
The release is preferred to a member that could clear `missing_lead`, meaning a resolved lead or the program-like or organizational lead exemption, because spending it on a row nothing can promote leaves the cluster dark.
