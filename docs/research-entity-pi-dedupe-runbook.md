...
It only groups entities where neither twin carries an attached PI person lead, so a person entity mislabeled with an organization's name is never merged into it.
