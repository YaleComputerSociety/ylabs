...
The lead-name gate this lane defines is shared with the path-keyed lane, so a group site hosting several distinct faculty is never collapsed (issue #1130).
