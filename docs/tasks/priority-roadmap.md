...
| P2       | Complete research-model refactor Phase 0.                                        | Development, Beta, and ProductionCopy inventory, search-baseline, and query-cost evidence, the phase ownership map, and rollback evidence are reviewed under the [Phase 0 runbook](../research-model-refactor-phase0.md). |
