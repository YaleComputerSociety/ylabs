...
A candidate whose `rosterProvenance.evidenceStatus` is `verified` is also left alone, because the entity's own official roster page listed that person and a genuine same-surname co-lead is otherwise indistinguishable from a graft.
