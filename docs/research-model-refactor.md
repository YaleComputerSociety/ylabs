...
| [Phase 3](https://github.com/YaleComputerSociety/ylabs/issues/207) | **Partial**: dedicated bibliographic sources, schedules, and standard release-gate invocations are retired while rollback code and storage remain | **Pending**: outbound-link, search-parity, archive, and rollback acceptance                                              | **Paused at reversible preparation**: dedicated producers are disabled, but public scholarly readers, materializers, audits, promotion paths, and storage remain |
| [Phase 4](https://github.com/YaleComputerSociety/ylabs/issues/208) | **Foundation only**: first-class access records exist, but clean entity, classification, taxonomy, and planning migrations do not                 | **Blocked**: canonical entity, access, opportunity, and private-plan parity review waits for earlier exits               | **Not started**: live entity, access, listing, fellowship, and saved-plan compatibility paths remain                                                             |
