...
| [Phase 3](https://github.com/YaleComputerSociety/ylabs/issues/207) | **Partial**: bibliographic scraper implementations, active source metadata, schedules, release-gate invocations, hidden publication producers, repair writers, generic paper Observation materialization, and public research-detail paper sections are retired while historical provenance and storage remain | **Pending**: outbound-link, search-parity, archive, and rollback acceptance                                              | **Paused at reversible preparation**: public UI no longer renders paper-derived sections and paper materializers fail closed by default, but server payload readers, audits, promotion paths, Meilisearch configuration, and storage remain |
| [Phase 4](https://github.com/YaleComputerSociety/ylabs/issues/208) | **Foundation only**: first-class access records, a bounded review-only legacy-record classification planner, and guarded orphaned-Observation repair tooling exist; clean entity, taxonomy, and planning migrations do not       | **Blocked**: repaired Development evidence acceptance and canonical entity, access, opportunity, and private-plan parity review wait for earlier exits | **Not started**: live entity, access, listing, fellowship, and saved-plan compatibility paths remain                                                                                        |
