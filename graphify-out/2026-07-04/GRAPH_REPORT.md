...
## Corpus Check
- 805 files · ~1,289,170 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11364 nodes · 20903 edges · 3491 communities (920 shown, 2571 thin omitted)
...
- [[_COMMUNITY_passportLogout.test.ts|passportLogout.test.ts]]
...
## Communities (3491 total, 2571 thin omitted)
...
Cohesion: 0.07
Nodes (40): FellowshipModal(), ArchivedBadge(), BrowseCard, BrowseCardProps, BrowseGrid(), BrowseGridProps, BrowseListItem, BrowseListItemProps (+32 more)
...
Cohesion: 0.07
Nodes (70): summarizeFetchMetrics, absolutize(), canonicalProfileUrlFromHtml(), cleanProfileSectionText(), cleanText(), csFacultyDataExtractor(), csJsRenderedStub(), csRenderedExtractor() (+62 more)

### Community 5 - "index.ts"
Cohesion: 0.09
Nodes (25): FellowshipModalProps, sortOptions, copy, FirstSaveCallout(), FirstSaveCalloutProps, dateValue(), fellowshipQuickFilters, Fellowships() (+17 more)

### Community 6 - "App.tsx"
Cohesion: 0.04
Nodes (36): PlanningOverview(), PlanningOverviewProps, pluralize(), scrollPositions, ScrollToTop(), normalizeReturnPath(), SignInButton(), SignInButtonProps (+28 more)
...
Cohesion: 0.08
Nodes (53): ADMIN_UPDATE_FIELDS, ALLOWED_SELF_UPDATE_FIELDS, appointmentTitleCount(), capitalizeSentenceStart(), cleanPublicProfileBio(), cleanResearchHomeSummaryForBio(), clipPublicProfileBio(), dedupeProfileResearchEntities() (+45 more)
...
Cohesion: 0.09
Nodes (41): DeveloperCard(), DeveloperCardProps, RichText(), decodeHtmlEntities(), decodeNumericEntity(), isScholarlyLink(), LabPapersList(), LabPapersListProps (+33 more)
...
Cohesion: 0.07
Nodes (70): getResearchGroupBySlug(), defaultOwnerToGroupSlug(), PublicResearchEntityDto, addPublicMemberField(), addPublicMemberInternalProfilePath(), addPublicMemberProfileUrls(), addPublicPaperField(), boundedResearchFilterValues() (+62 more)
...
Cohesion: 0.10
Nodes (39): authConfig, authDebug(), AuthenticatedSessionUser, buildAuthenticatedSessionUser(), buildDirectoryUpdate(), casLogin(), DEV_LOGIN_PROFILES, ensureDevLoginUser() (+31 more)
...
Cohesion: 0.11
Nodes (33): AdvisorAggregateRow, aggregateAdviseesByAdvisor(), buildObservationsForAdvisor(), DEFAULT_ACCEPTED_FELLOWSHIP_RECIPIENT_PDF_DIR, DEFAULT_PROGRAM_CONFIGS, drupalRecipientRowExtractor(), escapeRegex(), ExtractorCtx (+25 more)
...
Cohesion: 0.05
Nodes (70): formatDate(), PathwayActionCard(), PathwayActionCardProps, ResearchPageSnapshot, LabPaper, PathwayActionability, PathwayBestNextStepCategory, PathwayContactRouteSummary (+62 more)
...
Cohesion: 0.08
Nodes (32): fellowship, COLUMNS, FellowshipKanbanBoardProps, defaultFellowshipSearchContext, FellowshipSearchContextType, container, root, mockedAxios (+24 more)
...
Cohesion: 0.07
Nodes (52): ResearchEntityPiDedupeRow, actionRepairReasons, applyStudentVisibilityGatePlans(), buildNameOnlyVisibilityDedupeRows(), buildSamePiVisibilityDedupeRows(), countByEntityId(), defaultGateDeps, entityDuplicateUrls() (+44 more)

### Community 38 - "ScraperContext"
Cohesion: 0.05
Nodes (53): normalizeUserType(), publicationSchema, User, userSchema, PaperAuthorshipEvidence, ArxivPreprintScraperOptions, entityKeyForResult(), EUROPE_PMC_SOURCE_CONFIG (+45 more)
...
Cohesion: 0.11
Nodes (35): publicSafeStudentVisibilityTiers, publicStudentVisibilityTiers, StudentVisibilityTier, studentVisibilityTiers, applyProgramUpdates(), applyResearchUpdates(), assertStudentVisibilityBackfillApplyAllowed(), buildNameOnlyVisibilityDedupeRows() (+27 more)
...
Cohesion: 0.10
Nodes (26): ProfileEditor(), ProfileEditorProps, ProfileHeaderProps, storeLogoutReturnPath(), UserButton(), formatRoleLabel(), Profile(), ROLE_LABELS (+18 more)
...
Cohesion: 0.09
Nodes (31): ActiveResearchSearchRequest, buildDepartmentSearchTargets(), DepartmentResearchHomeConfig, DepartmentSearchTarget, emptyGroupedResults(), hasStructuredFilters(), isResearchEntitySearchExhausted(), pluralize() (+23 more)
...
Cohesion: 0.08
Nodes (62): ACTIVE_FILTER, asString(), asStringArray(), buildBetaDataQualityScorecard(), buildCollectionCounts(), buildDescriptionQuality(), buildDuplicateEntityNames(), buildLiveLinkCheck() (+54 more)

### Community 60 - "studentVisibilityTier.ts"
Cohesion: 0.11
Nodes (34): classifyProgramResearchRelevance(), ProgramResearchRelevanceInput, ProgramResearchRelevanceResult, RESEARCH_PROGRAM_KINDS, RESEARCH_PURPOSES, computeProgramStudentVisibility(), computeResearchEntityStudentVisibility(), entityUrls() (+26 more)
...
Cohesion: 0.06
Nodes (44): LabInquireModal(), LabInquireModalProps, LabMembersList(), LabMembersListProps, ROLE_LABELS, ROLE_ORDER, ROLE_PILL_CLASSES, baseGroup (+36 more)
...
Cohesion: 0.07
Nodes (59): AcceptedInputIssue, AcceptedInputUser, applyOrcidCrosswalkCsv(), applyScholarAcceptedCsv(), ArxivResolvedTarget, ArxivValidationResult, buildAcceptedInputsStatus(), buildArxivCandidateRows() (+51 more)
...
Cohesion: 0.04
Nodes (54): AdminOperatorBoard(), ArtifactFreshnessStrip(), classifyReason(), DataQualityDuplicateNamePreflight, DataQualitySamePiDedupeReview, DataQualitySuspiciousUserEmailCopy, decisionLaneCopy, evidenceReasons (+46 more)
...
Cohesion: 0.09
Nodes (39): acceptedPath(), AdvisorResolution, AdvisorResolver, assertAcceptedInputPathRoot(), candidateRowsFromText(), coerceReviewRow(), defaultAdvisorResolver(), escapeCsvCell() (+31 more)
...
Cohesion: 0.10
Nodes (43): ResearchGroupMember, researchGroupMemberSchema, ProfileBackedFacultyResearchAreaMemberDeps, ResolvedRelationshipMaterializationDeps, defaultCenterFinder(), applyMemberReferenceRepairs(), buildCurrentMemberOnArchivedEntityPipeline(), buildExistingMemberMatchQuery() (+35 more)
...
Cohesion: 0.07
Nodes (26): VennDiagramToggle(), VennDiagramToggleProps, CombinedFilterDropdown(), CombinedFilterDropdownProps, FilterTabConfig, COLUMNS, KanbanBoardProps, ResizeObserverMock (+18 more)
...
Cohesion: 0.10
Nodes (43): fieldProvenanceSchema, Paper, paperSchema, PaperAuthor, paperAuthorSchema, applyCleanup(), applyIntegrityCleanup(), assertPaperAuthorshipAuditApplyAllowed() (+35 more)

### Community 88 - "Observation"
Cohesion: 0.15
Nodes (20): Observation, observationSchema, ScrapeRun, scrapeRunSchema, buildSupersededObservationPruneFilter(), findKeptRunIds(), nonNegativeInteger(), positiveInteger() (+12 more)
...
Cohesion: 0.14
Nodes (31): defaultFetchUrl(), setCached(), defaultFetchPage(), defaultFetchPage(), fetchHtml(), fetchDeptData(), fetchHtml(), defaultFetchHtml() (+23 more)

### Community 93 - "studentDecisionLLMExtractor.ts"
Cohesion: 0.08
Nodes (47): buildStudentDecisionPrompt(), candidateMatchesOnly(), clean(), compactSourceUrls(), DecisionCandidate, DecisionCandidateLoader, DecisionCandidateSelectionOptions, decisionExtractionToObservation() (+39 more)

### Community 94 - "AdminFellowshipsTable.tsx"
Cohesion: 0.10
Nodes (22): AdminFellowship, AdminFellowshipsTable(), FellowshipEditModal(), FellowshipLink, PAGE_SIZES, SortField, TABLE_COLUMNS, AdminFellowshipFormAction (+14 more)
...
Cohesion: 0.12
Nodes (26): assertUserMigrationApplyAllowed(), assertUserMigrationReplacementAllowed(), buildUserMigrationOutput(), __dirname, __filename, migrateUsers(), UserMigrationCliOptions, UserMigrationResult (+18 more)
...
Cohesion: 0.07
Nodes (33): PrivateRoute(), PrivateRouteProps, InfiniteScrollLoadingDots(), InfiniteScrollLoadingDotsProps, LoadingSpinner(), LoadingSpinnerProps, sizeMap, LongText() (+25 more)

### Community 103 - "assertPublicHttpUrl"
Cohesion: 0.05
Nodes (64): ResearchEntityType, ScraperOrchestrator, CenterAffiliationLLMExtractor, CrossrefFetcher, CrossrefMessage, crossrefMessageToObservations(), CrossrefPaperScraper, CrossrefPaperScraperOptions (+56 more)
...
Cohesion: 0.08
Nodes (42): absolutize(), canonicalLegacyResearchHomeUrl(), canonicalUrlFromHtml(), cleanInterestForBio(), derivedBioFromOfficialProfile(), derivedBioFromOfficialProfileInterests(), entityExpectedPeople(), entityNameAsUser() (+34 more)

### Community 107 - "pathwaySearchService.ts"
Cohesion: 0.06
Nodes (55): allowedValues(), hasOversizedStringList(), isOversizedSearchRequest(), parseFilters(), parseSearchInput(), parseSort(), publicPathwayResearchEntity(), publicPathwaySearchResult() (+47 more)
...
Cohesion: 0.10
Nodes (28): buildProfileResearchMembershipFilter(), cleanPublicSourceLabel(), cleanScholarlyTitle(), cleanUrl(), dateToIso(), isDatasetLikeScholarlyLink(), isGeneratedOfficialProfilePublicationAnchor(), isOfficialProfileScholarlyLink() (+20 more)

### Community 113 - "smartTitle.ts"
Cohesion: 0.10
Nodes (29): VisibilityReleaseQueueCollection, visibilityReleaseQueueCollections, visibilityReleaseQueueItemSchema, VisibilityReleaseQueueStatus, visibilityReleaseQueueStatuses, VisibilityRepairStage, visibilityRepairStages, VisibilityRepairStatus (+21 more)
...
Cohesion: 0.13
Nodes (40): member(), actionReasons, cleanResearchInterest(), defaultRepairDeps, entityPersonDisplayName(), interestCorroboratedByBio(), isLeadMember(), isLikelyPersonProfileUrl() (+32 more)
...
Cohesion: 0.12
Nodes (18): MockIntersectionObserver, TestScroller(), useInfiniteScroll(), UseInfiniteScrollOptions, Home(), BrowsePageAction, browsePageReducer(), BrowsePageState (+10 more)
...
Cohesion: 0.16
Nodes (22): ACCEPTED_INPUT_FILE_EXTENSIONS, assertSafeAcceptedInputPathText(), resolveSafeAcceptedInputPath(), assertAcceptedInputsApplyAllowed(), buildAcceptedInputsOutput(), CliOptions, COMMANDS_REQUIRING_DB, COMMANDS_SUPPORTING_APPLY (+14 more)
...
Cohesion: 0.18
Nodes (20): addFavoriteToFellowship(), addViewToFellowship(), boundedSearchQuery(), getFellowshipById(), getFellowshipFilterOptions(), numericSearchParam(), parseFilter(), PUBLIC_FELLOWSHIP_SORT_FIELDS (+12 more)

### Community 141 - "applicationRoutePathwayBackfillCore.ts"
Cohesion: 0.11
Nodes (40): ContactRouteType, materializeAccessForResearchGroup(), pathwayDerivationKeyForRoute(), pathwayDerivationKeyForSignal(), applicationRouteBackfillDerivationKey(), ApplicationRoutePathwayBackfillDeps, ApplicationRoutePathwayBackfillEntity, ApplicationRoutePathwayBackfillOptions (+32 more)

### Community 142 - "launchTrustContractService.ts"
Cohesion: 0.29
Nodes (8): buildRepairQueueSummary(), buildVisibilityRepairPiMemberUpsert(), buildVisibilityRepairPlan(), buildVisibilityRepairPlans(), normalizeVisibilityRepairObjectId(), repairActionForStage(), runVisibilityRepairQueue(), toVisibilityRepairObjectId()

### Community 143 - "fellowshipController.ts"
Cohesion: 0.19
Nodes (18): ScraperEnvironment, BetaSeedEnvironmentCliOptions, BetaSeedPlan, BetaSeedPlanStep, BetaSeedRunResult, BetaSeedTargetMetadata, buildBetaSeedPlan(), __filename (+10 more)

### Community 144 - "department.ts"
Cohesion: 0.16
Nodes (17): CallCenterDirectorLLMFn, CandidateCenter, CenterDirector, CenterDirectorExtraction, CenterDirectorLLMExtractor, CenterDirectorLLMExtractorDeps, CenterFinderFn, defaultCallLLM() (+9 more)
...
Cohesion: 0.09
Nodes (24): categoryColorKeys, Department, DepartmentCodeSystem, departmentSchema, sourceRecordSchema, facultyMemberSchema, Listing, listingSchema (+16 more)
...
Cohesion: 0.06
Nodes (58): ACCESS_EVIDENCE_CONFLICT_FIELDS, ADDITIVE_METADATA_CONFLICT_FIELDS, AggregatedCrossSourceObservationConflictGroup, buildCategoryCounts(), buildConflictPlan(), buildCrossSourceObservationConflictReviewOutput(), buildCrossSourceObservationConflictSummary(), buildCrossSourceObservationDecisionTemplate() (+50 more)
...
Cohesion: 0.22
Nodes (26): archivedResearchEntityRepairBlock(), attemptProgramRepair(), attemptResearchActionEvidenceRepair(), attemptResearchRepair(), attemptVisibilityRepair(), buildResearchSourceDescriptionPatch(), createEntitySourceActionEvidenceRepair(), createOfficialProfileActionEvidenceRepair() (+18 more)
...
Cohesion: 0.20
Nodes (15): hasOversizedStringList(), isOversizedSearchRequest(), OPERATOR_ALLOWED_SORT_FIELDS, parseFilters(), parsePositiveIntegerParam(), parseQualityFilters(), parseStudentVisibilityTiers(), PUBLIC_ALLOWED_SORT_FIELDS (+7 more)

### Community 161 - "GStack Production Promotion Iteration Implementation Plan"
Cohesion: 0.14
Nodes (17): ScrapeSnapshot, scrapeSnapshotSchema, getCached(), invalidateCache(), arxivEntryToObservations(), ArxivFetcher, ArxivPreprintScraper, buildAuthorSearchQuery() (+9 more)
...
Cohesion: 0.18
Nodes (21): generatedOfficialProfileUrlCandidatesForPerson(), isOfficialYalePersonPageUrl(), isOfficialYaleProfileUrl(), isPotentialDirectYalePersonPageUrl(), nameMatchesEntity(), normalizeOfficialProfileUrl(), officialPersonUrlMatchesEntity(), officialProfileSlugMatchesGivenNameVariant() (+13 more)

### Community 171 - "logSanitizer.ts"
Cohesion: 0.17
Nodes (20): cleanOfficialProfileDisplayName(), cleanOfficialProfileTitle(), clipOfficialProfileBio(), extractBio(), extractDepartments(), extractEmail(), extractImageUrl(), extractOfficialProfileIdentity() (+12 more)
...
Cohesion: 0.08
Nodes (47): backfillV4PaperGraph(), buildV4PaperGraphBlockedOutput(), DeprecatedV4BackfillMetadata, DeprecatedV4BackfillOutput, writeV4PaperGraphBlockedOutput(), backfillV4ResearchGroupMembers(), facultyIdForMember(), __filename (+39 more)

### Community 184 - "scholarlyLinkSuppressionAudit.ts"
Cohesion: 0.21
Nodes (14): AdminProfile, AdminProfileEditModal(), AdminProfileEditModalProps, AdminProfileEditAction, adminProfileEditReducer(), AdminProfileEditState, AdminProfileShape, createInitialAdminProfileEditState() (+6 more)
...
Cohesion: 0.08
Nodes (26): ResearchField, router, hasDirectContactInfo(), router, routeHandlerNames(), routesByPath(), invokeRouteHandler(), mocks (+18 more)
...
Cohesion: 0.13
Nodes (33): buildFundingGroupFromCluster(), buildGroupFromCluster(), buildOfficialLabUrlResearchEntityDedupePlan(), buildProfileAreaShellDuplicateGroup(), buildResearchEntityPiDedupePlan(), canonicalScore(), cleanMergedResearchAreas(), comparablePiLabName() (+25 more)
...
Cohesion: 0.28
Nodes (11): buildLaunchTrustContractOutput(), CliOptions, __filename, main(), parseLaunchTrustContractArgs(), parsePositiveInteger(), parseRequiredValue(), writeLaunchTrustContractOutput() (+3 more)
...
Cohesion: 0.17
Nodes (13): acceptanceLevelClauses(), AcceptanceLevelInput, buildResearchGroupFilterString(), escapeMeiliFilterValue(), orEqualsClause(), ResearchGroupFilterInput, boundedResearchSearchQuery(), isMissingMeiliEmbedderError() (+5 more)
...
Cohesion: 0.08
Nodes (53): ScrapeJobLock, scrapeJobLockSchema, Source, __dirname, __filename, main(), BOOLEAN_FLAGS, buildCronOutputPayload() (+45 more)
...
Cohesion: 0.11
Nodes (17): normalizeSeedNetid(), requireLocalSeedRuntime(), requireSeedToken(), router, SEED_USER_FIELDS, seedListingSummary(), seedUserPayload(), seedUserSummary() (+9 more)
...
Cohesion: 0.32
Nodes (8): DepartmentInput(), DepartmentInputProps, useConfig(), createInitialDepartmentInputState(), DepartmentInputAction, departmentInputReducer(), DepartmentInputState, resolve()
...
### Community 268 - "AdminFellowshipEditModal.tsx"
Cohesion: 0.27
...
Cohesion: 0.05
Nodes (45): AdminRoute(), AdminRouteProps, getLocalAdminDevLoginUrl(), getSafeLocalAdminRedirectTarget(), CourseTableCourse, CourseTableSection(), CourseTableSectionProps, formatSeason() (+37 more)
...
### Community 274 - "BackfillV4FacultyMembers.ts"
Cohesion: 0.32
...
### Community 282 - "launchAcquisitionReport.ts"
Cohesion: 0.33
...
### Community 287 - "Codex Guide"
Cohesion: 0.38
Nodes (9): LaunchReviewExceptionCliOptions, assertStudentVisibilityGateApplyConfirmed(), buildStudentVisibilityGateOutput(), main(), parsePositiveInteger(), parseStudentVisibilityGateArgs(), StudentVisibilityGateCliOptions, writeStudentVisibilityGateOutput() (+1 more)
...
### Community 306 - "normalizeCrossSourceReviewDecision"
Cohesion: 0.70
...
Cohesion: 0.18
Nodes (17): publicProgramLinks(), publicProgramText(), publicProgramTextArray(), defaultCallLLM(), defaultRewriter(), cache, CourseTableCourse, fetchAllSeasonCourses() (+9 more)
...
Cohesion: 0.08
Nodes (29): AdminListing, AdminListingsTable(), PAGE_SIZES, SORT_OPTIONS, SortField, TABLE_COLUMNS, AdminListingsFilter, AdminListingsSortField (+21 more)
...
Cohesion: 0.10
Nodes (28): AccessSignal, accessSignalSchema, ContactRoute, contactRouteSchema, EntryPathway, entryPathwaySchema, opennessSignalSchema, recordReviewSchema (+20 more)

## Knowledge Gaps
- **4660 isolated node(s):** `name`, `version`, `private`, `node`, `@emotion/react` (+4655 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **2571 thin communities (<3 nodes) omitted from report** — run `graphify query` to explore isolated nodes.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `sanitizeLogValue()` connect `sanitizeLogValue` to `departmentRosterScraper.ts`, `assertScriptApplyAllowed`, `labMicrositeUndergradLLMExtractor.ts`, `entityMaterializer.ts`, `researchGroupService.ts`, `labMicrositeDescriptionLLMExtractor.ts`, `passport.ts`, `undergradFellowshipRecipientScraper.ts`, `duplicateEntityNameReview.ts`, `dedupeResearchEntitiesByPi.ts`, `admin.ts`, `BackfillV4ResearchGroupMembers.ts`, `profileDataQualityAudit.ts`, `centersInstitutesScraper.ts`, `nihReporterScraper.ts`, `ScraperContext`, `userService.ts`, `serializedDocumentId`, `researchEntityCoverageAudit.ts`, `sourceHealth.ts`, `ScrapeRun`, `listingService.ts`, `runReport.ts`, `redactDirectContactInfo`, `staleObservationConflictReview.ts`, `betaDataQuality.ts`, `listingController.ts`, `analyticsService.ts`, `entryPathwayService.ts`, `yaleCollegeFellowshipsOfficeScraper.ts`, `repairOfficialProfilePublicationPointers.ts`, `OfficialProfilePublicationValue`, `postedOpportunityService.ts`, `profileController.ts`, `analytics.ts`, `openAlexPaperScraper.ts`, `researchEntityMemberReferenceAudit.ts`, `promoteAcceptedBetaCopy.ts`, `paperAuthorshipAudit.ts`, `studentDecisionLLMExtractor.ts`, `backfillProfileBiosFromOfficialUrls.ts`, `resolveSafeJsonReportOutputPath`, `accessClaims.ts`, `assertPublicHttpUrl`, `officialProfilePiBackfillScraper.ts`, `repairArchivedEntityArtifacts.ts`, `centerDirectorLLMExtractor.ts`, `pathwayQualityAudit.ts`, `Adding a New Endpoint`, `buildAdminOperatorBoard`, `launchReviewExceptions.ts`, `Current Execution Plan`, `File Structure`, `dedupeUsersByIdentity.ts`, `officialProfilePiBackfillScraper.test.ts`, `applicationRoutePathwayBackfillCore.ts`, `fellowshipController.ts`, `department.ts`, `profileBioCoverageAudit.ts`, `Beta Source/PI/Action Audit Implementation Plan`, `crossSourceObservationConflictReview.ts`, `migrateResearchEntities.ts`, `researchQualitySearchReview.ts`, `migrateResearchEntityCollections.ts`, `researchGroupController.ts`, `GStack Production Promotion Iteration Implementation Plan`, `disambiguateSurnameLabNames.ts`, `repairDuplicateAccessSignals.ts`, `programController.ts`, `repairMismatchedPersonEmailsCore.ts`, `betaReadinessGate.ts`, `studentVisibilityRepairTargets.ts`, `cleanupLegacyMongoCollections.ts`, `seedSources.ts`, `researchAreas.ts`, `migrateMongoNaming.ts`, `listings.ts`, `3. Configure environment`, `userEmailHygiene.ts`, `Adding Things`, `meiliSyncService.ts`, `repairProfileDescriptionBackfillConflicts.ts`, `clearBetaStudentAnalytics.ts`, `scraperIntegrityDuplicateReview.ts`, `departmentLeadRepairPlanCore.ts`, `auditResearchEntityRename.ts`, `betaRepairQueue.ts`, `1. Fresh machine setup`, `paperQualityService.ts`, `pathwayRelevanceReview.ts`, `programs.ts`, `scriptWriteGuards.ts`, `adminTableReducer.test.ts`, `backfillResearchHomeOfficialUrls.ts`, `seed.ts`, `scraperIntegrityGate.ts`, `users.ts`, `launchAcquisitionReport.ts`, `index.ts`, `Codex Guide`, `refreshGateScorecards.ts`, `dedupeExploratoryContactPathways.ts`, `corsOrigin.ts`, `materializePaperObservationsFromRun`, `adminFellowshipsTableReducer.ts`, `importFaculty.ts`, `refreshGateScorecards.ts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `ResearchGroup` connect `researchEntityBrowseRankService.ts` to `labDetail.tsx`, `browsable.ts`, `ImportRootDataFiles.ts`, `BackfillV4Grants.ts`, `v4MigrationUtils.ts`, `cli.ts`?**
  _High betweenness centrality (0.050) - this node is a cross-community bridge._
- **Why does `member()` connect `Adding a New Endpoint` to `labDetail.tsx`, `centersInstitutesScraper.ts`, `departmentRosterScraper.ts`, `disambiguateSurnameLabNames.ts`, `research-detail-professor-audit.mjs`, `researchGroupService.ts`, `meiliSyncService.ts`, `textValue`, `profileBioCoverageAudit.ts`, `v4MigrationUtils.ts`, `researchEntitySearchIndexService.ts`, `visibilityRepairQueueService.ts`, `studentVisibilityTier.ts`, `researchQualitySearchReview.ts`, `researchEntityBrowseRankService.ts`?**
