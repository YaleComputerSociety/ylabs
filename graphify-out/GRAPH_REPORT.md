...
## Corpus Check
- 839 files · ~1,312,473 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11199 nodes · 21488 edges · 3111 communities (913 shown, 2198 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `f82001e2`
...
- [[_COMMUNITY_snapshotCache.ts|snapshotCache.ts]]
- [[_COMMUNITY_Listing|Listing]]
- [[_COMMUNITY_scholarlyLinkSuppressionAudit.ts|scholarlyLinkSuppressionAudit.ts]]
- [[_COMMUNITY_centerAffiliationLLMExtractor.ts|centerAffiliationLLMExtractor.ts]]
...
- [[_COMMUNITY_europePmcPaperScraper.ts|europePmcPaperScraper.ts]]
...
- [[_COMMUNITY_programService.test.ts|programService.test.ts]]
...
## Communities (3111 total, 2198 thin omitted)
...
Cohesion: 0.05
Nodes (73): adminQualityNotes(), AffiliatedResearchEntitiesSection(), compactDepartmentLabels(), decisionNextStep(), DecisionSummary(), dedupeLeadMembers(), detailDescription(), detailTopics() (+65 more)

### Community 2 - "browsable.ts"
Cohesion: 0.05
Nodes (56): FellowshipModal(), FellowshipModalProps, RichText(), ArchivedBadge(), BrowseCard, BrowseCardProps, BrowseGrid(), BrowseGridProps (+48 more)
...
### Community 5 - "researchEntityEvidenceCoverage.ts"
Cohesion: 0.11
...
### Community 6 - "App.tsx"
Cohesion: 0.03
Nodes (57): PlanningOverview(), PlanningOverviewProps, pluralize(), AdminRoute(), AdminRouteProps, getLocalAdminDevLoginUrl(), getSafeLocalAdminRedirectTarget(), HttpStatusNotifier() (+49 more)

### Community 7 - "initializeConnections"
Cohesion: 0.08
Nodes (28): ApiMode, getApiMode(), initializeConnections(), mongoOptions, startApp(), __filenameLocal, gateRefreshIntervalMs(), SERVER_ROOT (+20 more)
...
Cohesion: 0.06
Nodes (73): ADMIN_UPDATE_FIELDS, ALLOWED_SELF_UPDATE_FIELDS, appointmentTitleCount(), capitalizeSentenceStart(), cleanPublicHttpUrl(), cleanResearchHomeSummaryForBio(), dedupeProfileResearchEntities(), degreeTokenCount() (+65 more)

### Community 10 - "labMicrositeDescriptionLLMExtractor.ts"
Cohesion: 0.12
Nodes (33): CallDescriptionLLMFn, CandidateDescriptionLab, CandidateDescriptionLabDoc, candidateDescriptionLabsFromDocs(), candidateKeyMatches(), candidateUrlsForDoc(), defaultCallLLM(), defaultLabFinder() (+25 more)

### Community 11 - "listingClaimRequestService.ts"
Cohesion: 0.12
...
Cohesion: 0.05
Nodes (104): FacultyMember, facultyMemberSchema, defaultOwnerToGroupSlug(), PublicResearchEntityDto, addPublicMemberField(), addPublicMemberInternalProfilePath(), addPublicMemberProfileUrls(), addPublicPaperField() (+96 more)
...
Cohesion: 0.09
Nodes (50): AccessSignalConfidence, accessArtifactCandidatesFromDerived(), AccessMaterializationResult, AccessObservation, bestObservation(), confidenceLabel(), contactSignalExcerpt(), deriveAccessArtifactsFromObservations() (+42 more)
...
Cohesion: 0.10
Nodes (70): mocks, privateProgram, addFavFellowships(), addFavListings(), addFavPathways(), addSavedPrograms(), addSavedResearchPlans(), ALLOWED_SELF_USER_TYPES (+62 more)

### Community 19 - "ResearchGroupMember"
Cohesion: 0.05
Nodes (69): ResearchGroupMember, ActiveArtifactOnArchivedEntity, buildDuplicateAccessSignalGroupsFromRows(), buildDuplicateResearchPaperGroupsFromRows(), BuildPostMaterializationIntegrityInput, buildPostMaterializationIntegritySummary(), buildSamePiNameDuplicateGroupsFromDedupeRows(), CurrentMemberOnArchivedEntity (+61 more)

### Community 20 - "passport.ts"
Cohesion: 0.07
Nodes (49): authConfig, authDebug(), AuthenticatedSessionUser, buildAuthenticatedSessionUser(), buildDirectoryUpdate(), casLogin(), DEV_LOGIN_PROFILES, ensureDevLoginUser() (+41 more)

### Community 21 - "Navbar.tsx"
Cohesion: 0.04
Nodes (48): AboutButton(), ListingEditor(), DepartmentInput(), DepartmentInputProps, AnalyticsButton(), FeedbackButton(), getAcademicDisciplineColor(), getResearchAreaChipColor() (+40 more)

### Community 22 - "undergradFellowshipRecipientScraper.ts"
Cohesion: 0.11
Nodes (28): AdvisorAggregateRow, buildObservationsForAdvisor(), DEFAULT_ACCEPTED_FELLOWSHIP_RECIPIENT_PDF_DIR, DEFAULT_PROGRAM_CONFIGS, escapeRegex(), ExtractorCtx, FellowshipRecipient, findUserForAdvisor() (+20 more)
...
Cohesion: 0.04
Nodes (84): AccessReviewCounts, AccessReviewDetail, AccessReviewEntitySummary, AccessSignal, AdminAccessReview(), ContactRoute, EntryPathway, evidenceIds() (+76 more)

### Community 28 - "researchDiscoveryAdapters.ts"
Cohesion: 0.03
Nodes (137): cleanResearchInterest(), ResearchInterests(), ResearchInterestsProps, SOURCE_CHROME_PATTERNS, splitCleanResearchInterest(), formatDate(), PathwayActionCard(), PathwayActionCardProps (+129 more)
...
Cohesion: 0.14
Nodes (27): absolutize(), CenterConfig, CenterExtractor, CenterKind, centerMemberRelationshipObservations(), centerMemberRelationshipObservationsForEntityKey(), CentersInstitutesScraper, centerToGroupObservations() (+19 more)

### Community 34 - "axios.ts"
Cohesion: 0.03
Nodes (82): AdminFellowshipEditModal(), Props, mockedAxios, fellowship, renderModal(), CourseTableCourse, CourseTableSection(), CourseTableSectionProps (+74 more)
...
### Community 38 - "orcidWorksScraper.ts"
Cohesion: 0.10
...
Cohesion: 0.08
Nodes (55): readListing(), addDepartments(), assertSafeUserUpdateDocument(), badRequestError(), buildCaseInsensitiveNetidFilter(), buildSavedPathwayPlansExport(), buildSavedPathwayPlanUnsetForIds(), clearDepartments() (+47 more)

### Community 40 - "serializedDocumentId"
Cohesion: 0.09
Nodes (39): normalizeSeedNetid(), requireLocalSeedRuntime(), requireSeedToken(), SEED_USER_FIELDS, seedListingSummary(), seedUserPayload(), seedUserSummary(), tokensMatch() (+31 more)
...
Cohesion: 0.08
Nodes (39): ProfileEditor(), ProfileEditorProps, orcidHref(), ProfileHeader(), ProfileHeaderProps, profileLinkDedupeKey(), profileUrlLinks(), shouldHideBroadSchoolLabel() (+31 more)
...
Cohesion: 0.10
Nodes (30): RESEARCH_ENTITY_TYPES, ResearchEntityType, LogEventParams, AnalyticsUser, buildResearchEvent(), BuildResearchEventInput, cleanHost(), cleanLabel() (+22 more)
...
Cohesion: 0.15
Nodes (34): annotateEntitiesWithLeadUsers(), annotateEntitiesWithSourceObservationUrls(), annotateProfileDescriptionPreferredSourceEvidence(), entityLeadDirectWebsiteToObservations(), entityResearchHomeToObservations(), firstNonDuplicateLeadDirectWebsiteUrl(), identityToResearchEntityDescriptionObservations(), identityToResearchEntityPiKeyObservations() (+26 more)

### Community 49 - "listingService.ts"
Cohesion: 0.08
Nodes (54): getListingModel(), DepartmentCategory, addFavorite(), archiveListing(), boundedListingDate(), boundedListingNetid(), boundedListingNetidArray(), boundedListingNumber() (+46 more)

### Community 50 - "fellowshipService.ts"
Cohesion: 0.11
Nodes (34): adminFellowshipDate(), adminFellowshipLinks(), adminFellowshipNumber(), adminFellowshipStringArray(), adminFellowshipText(), archiveFellowship(), boundedPublicText(), boundedSearchFilterValues() (+26 more)

### Community 51 - "betaDataQualityCore.ts"
Cohesion: 0.06
Nodes (51): BETA_CHECK_OPERATOR_METADATA, betaCommand(), BetaDataQualityCheck, BetaDataQualityDiagnostics, BetaDataQualityOptions, BetaDataQualityProgressEvent, BetaDataQualitySeverity, BetaDataQualitySummary (+43 more)
...
Cohesion: 0.09
Nodes (31): getOpportunityById(), normalizeOpportunityIdParam(), mocks, EntryPathway, PostedOpportunity, ListingPostedOpportunityMetricDeps, compactStrings(), evidenceExcerpt() (+23 more)
...
Cohesion: 0.10
Nodes (43): ACTIVE_FILTER, buildBetaDataQualityScorecard(), buildLiveLinkCheck(), buildPaperAuthorshipSummary(), buildReferenceAuditSamples(), buildReferenceIntegrity(), buildResearchEntityCoverage(), buildSourceHealthSummary() (+35 more)

### Community 60 - "studentVisibilityTier.ts"
Cohesion: 0.09
Nodes (40): classifyProgramResearchRelevance(), ProgramResearchRelevanceInput, ProgramResearchRelevanceResult, RESEARCH_PROGRAM_KINDS, RESEARCH_PURPOSES, computeProgramStudentVisibility(), computeResearchEntityStudentVisibility(), entityUrls() (+32 more)

### Community 61 - "listingController.ts"
Cohesion: 0.06
Nodes (57): addViewToListing(), archiveListingForCurrentUser(), boundedListingSearchQuery(), buildListingOutreachEvent(), buildMongoFilterMatch(), buildRobustFilterMatch(), createListingForCurrentUser(), deleteListingForCurrentUser() (+49 more)

### Community 62 - "labDetail.ts"
Cohesion: 0.05
Nodes (64): LabHeader(), LabHeaderProps, normalizeActionUrl(), LabInquireModal(), LabInquireModalProps, LabMembersList(), LabMembersListProps, ROLE_LABELS (+56 more)

### Community 63 - "analyticsService.ts"
Cohesion: 0.07
Nodes (62): AnalyticsEvent, ActionNeededAnalytics, ANALYTICS_EVENT_TYPES, ANALYTICS_NON_USER_NETIDS, ANALYTICS_RESEARCH_ENTITY_TYPES, AnalyticsUserDrilldownQuery, AnalyticsUserDrilldownResult, AnalyticsUserEvent (+54 more)

### Community 65 - "acceptedInputsCore.ts"
Cohesion: 0.07
Nodes (64): AcceptedInputIssue, AcceptedInputUser, applyOrcidCrosswalkCsv(), applyScholarAcceptedCsv(), ArxivResolvedTarget, ArxivValidationResult, asString(), asStringArray() (+56 more)

### Community 66 - "entryPathwayService.ts"
Cohesion: 0.09
Nodes (38): ContactPolicy, ContactRouteType, ContactRouteVisibility, DerivedContactRoute, AccessSignalServiceDeps, AccessSignalUpsertResult, compactObject(), getAccessSignalModel() (+30 more)

### Community 67 - "yaleCollegeFellowshipsOfficeScraper.ts"
Cohesion: 0.05
Nodes (75): assertFellowshipImportApplyAllowed(), buildFellowshipImportOutput(), cleanEmail(), cleanText(), __dirname, FellowshipCSVRow, FellowshipImportCliOptions, FellowshipImportResult (+67 more)
...
Cohesion: 0.04
Nodes (53): AdminOperatorBoard(), ArtifactFreshnessStrip(), classifyReason(), DataQualityDuplicateNamePreflight, DataQualitySamePiDedupeReview, DataQualitySuspiciousUserEmailCopy, decisionLaneCopy, evidenceReasons (+45 more)
...
Cohesion: 0.08
Nodes (43): ACCEPTED_INPUT_FILE_EXTENSIONS, acceptedPath(), AdvisorResolution, AdvisorResolver, assertAcceptedInputPathRoot(), candidateRowsFromText(), coerceReviewRow(), escapeCsvCell() (+35 more)
...
Cohesion: 0.11
Nodes (39): anyFilter(), boundedFilterValues(), boundedSearchQuery(), buildPathwayMeiliFilter(), buildPathwayMeiliSort(), buildPathwaySearchIndexDocument(), FetchPathwaySearchIndexPage, FORMALIZATION_ONLY_PATHWAY_TYPES (+31 more)

### Community 82 - "fellowshipController.ts"
Cohesion: 0.15
Nodes (23): addFavoriteToFellowship(), addViewToFellowship(), boundedSearchQuery(), numericSearchParam(), parseFilter(), PUBLIC_FELLOWSHIP_SORT_FIELDS, publicFellowshipPage(), publicFellowshipPageSize() (+15 more)
...
### Community 84 - "listingFormReducer.ts"
Cohesion: 0.31
...
### Community 88 - "backfillResearchDescriptions.ts"
Cohesion: 0.17
Nodes (15): defaultRewriter(), DESC_BLOCK_REASONS, DescriptionRewriter, __dirname, entityHttpUrls(), fetchGrantAbstract(), __filename, main() (+7 more)
...
Cohesion: 0.11
Nodes (18): browserslist, development, production, engines, node, eslintConfig, extends, name (+10 more)
...
### Community 95 - "researchEntityDescriptionText.ts"
Cohesion: 0.18
...
### Community 100 - "dedupeUsersByIdentity.ts"
Cohesion: 0.07
Nodes (59): applyUserIdentityDedupeGroups(), archiveDuplicateUniqueUserReferences(), assertDedupeUsersByIdentityApplyAllowed(), buildDedupeUsersByIdentityOutput(), buildUserIdentityCollisionPipeline(), IDENTITY_FIELDS, isMissing(), loadCollisions() (+51 more)

### Community 101 - "opportunityDetail.tsx"
Cohesion: 0.07
Nodes (34): PrivateRoute(), PrivateRouteProps, InfiniteScrollLoadingDots(), InfiniteScrollLoadingDotsProps, LoadingSpinner(), LoadingSpinnerProps, sizeMap, LongText() (+26 more)

### Community 103 - "redactDirectContactInfo"
Cohesion: 0.11
Nodes (25): hasDirectContactInfo(), defaultRewriter(), ADMIN_PROFILE_USER_TYPES, adminUpdateProfile(), boundedAdminProfileEmail(), boundedAdminProfileNumber(), boundedAdminProfileText(), boundedProfileString() (+17 more)
...
Cohesion: 0.06
Nodes (83): absolutize(), affiliationValuesFromProfiles(), canonicalLegacyResearchHomeUrl(), canonicalResearchHomeName(), canonicalUrlFromHtml(), classifyResearchHome(), cleanInterestForBio(), cleanOfficialProfileDisplayName() (+75 more)
...
### Community 108 - "researchAreasRoutes.test.ts"
Cohesion: 0.29
Nodes (4): router, invokeRouteHandler(), mocks, routesByPath()

### Community 109 - "researchEntityQuality.ts"
Cohesion: 0.11
Nodes (28): ACCESS_SIGNAL_POINTS, accessPoints(), computeResearchEntityBrowseRank(), descriptionPoints(), leadPoints(), ResearchEntityBrowseRankInput, __testing, accessSignalTypesByEntityId() (+20 more)
...
Cohesion: 0.12
Nodes (24): buildProfileResearchMembershipFilter(), cleanScholarlyTitle(), cleanUrl(), dateToIso(), isDatasetLikeScholarlyLink(), isGeneratedOfficialProfilePublicationAnchor(), isOfficialProfileScholarlyLink(), isOfficialProfileSourcePagePublicationPointer() (+16 more)
...
### Community 115 - "ObservationInput"
Cohesion: 0.14
Nodes (20): CallCenterDirectorLLMFn, CenterDirector, CenterDirectorExtraction, CenterDirectorLLMExtractor, CenterDirectorLLMExtractorDeps, CenterFinderFn, defaultCallLLM(), defaultCenterFinder() (+12 more)
...
### Community 119 - "cli.ts"
Cohesion: 0.17
Nodes (22): __dirname, __filename, main(), BOOLEAN_FLAGS, buildCronOutputPayload(), buildMaterializeOutputPayload(), buildScraperCliOutputPayload(), buildScraperCliPreflight() (+14 more)

### Community 120 - "cronRunner.ts"
Cohesion: 0.17
Nodes (18): ScrapeJobLock, scrapeJobLockSchema, createCronOwnerId(), CronRunnerDependencies, loadCronSource(), runScraperCron(), RunScraperCronResult, startHeartbeat() (+10 more)
...
### Community 125 - "snapshotCache.ts"
Cohesion: 0.13
Nodes (14): ScrapeSnapshot, scrapeSnapshotSchema, getCached(), invalidateCache(), DecisionCandidate, defaultCallLLM(), STUDENT_DECISION_RESPONSE_FORMAT, StudentDecisionLLMExtractor (+6 more)

### Community 126 - "Listing"
Cohesion: 0.06
Nodes (38): ActiveFilterChip, ActiveFiltersProps, QuickFilterDef, sortOptions, copy, FirstSaveCallout(), FirstSaveCalloutProps, ListingDetailModal() (+30 more)
...
### Community 128 - "centerAffiliationLLMExtractor.ts"
Cohesion: 0.14
Nodes (18): affiliationExtractionToObservations(), CallCenterAffiliationLLMFn, CandidateCenter, CenterAffiliationExtraction, CenterAffiliationLLMExtractor, CenterAffiliationLLMExtractorDeps, CenterAffiliationPerson, CenterFinderFn (+10 more)
...
### Community 135 - "workPlanner.ts"
Cohesion: 0.16
Nodes (18): ObservedEntityType, defaultWorkPlanLoader(), defaultWorkPlanLoader(), NOW, buildEntityWorkPlan(), BuildEntityWorkPlanOptions, BuildFieldPlanOptions, createWorkPlannerMetrics() (+10 more)
...
### Community 137 - "researchEntityDto.ts"
Cohesion: 0.23
...
### Community 140 - "studentDecisionExplanationService.ts"
Cohesion: 0.23
...
Cohesion: 0.07
Nodes (47): assertDepartmentMigrationApplyAllowed(), buildDepartmentMigrationOutput(), ChangeLog, DepartmentDoc, DepartmentMigrationCliOptions, DepartmentMigrationResult, __dirname, __filename (+39 more)

### Community 144 - "types.ts"
Cohesion: 0.05
Nodes (41): ScraperOrchestrator, CrossrefFetcher, CrossrefMessage, crossrefMessageToObservations(), CrossrefPaperScraper, CrossrefPaperScraperOptions, dateFromParts(), normalizeDoi() (+33 more)

### Community 145 - "FavoritesManager.tsx"
Cohesion: 0.06
Nodes (57): csvCell(), dateFormatter, deadlineEndOfUtcDay(), FavoritesManager(), FavoritesManagerProps, fellowshipToBrowsable(), savedProgramDeadlineSummary(), validDeadlineDate() (+49 more)
...
### Community 149 - "isPublicHttpUrl"
Cohesion: 0.19
Nodes (14): isPublicInstitutionalEmailDomain(), PUBLIC_CONTACT_EMAIL_DOMAINS, publicContactEmail(), publicAccessHttpUrl(), publicAccessHttpUrls(), ipv4ToNumber(), isAllowedPublicHttpPort(), isIpv4InCidr() (+6 more)
...
### Community 151 - "launchTrustContract.ts"
Cohesion: 0.20
...
### Community 154 - "visibilityRepairQueueService.test.ts"
Cohesion: 0.27
...
Cohesion: 0.07
Nodes (55): researchGroupMemberSchema, addMapSet(), aggregateCountAndTypes(), aggregateCountMap(), buildLexicalReasons(), buildResearchQualitySearchReviewOutput(), buildReview(), collectSearchCandidates() (+47 more)
...
Cohesion: 0.10
Nodes (27): getResearchGroupBySlug(), hasOversizedStringList(), isOversizedSearchRequest(), OPERATOR_ALLOWED_SORT_FIELDS, parseFilters(), parsePositiveIntegerParam(), parseQualityFilters(), parseStudentVisibilityTiers() (+19 more)

### Community 161 - "publicResearchSeo.ts"
Cohesion: 0.26
...
### Community 166 - "adminGrantService.ts"
Cohesion: 0.29
...
### Community 176 - "Observation"
Cohesion: 0.10
Nodes (30): Observation, observationSchema, Source, sourceSchema, AppendContext, appendObservations(), buildObservationFingerprint(), findObservations() (+22 more)
...
Cohesion: 0.06
Nodes (65): backfillV4FacultyMembers(), buildDepartmentMap(), compact(), departmentIdsFor(), __filename, isFacultyTitle(), norm(), slugify() (+57 more)
...
Cohesion: 0.08
Nodes (30): SourceCoverageArtifactType, sourceCoverageArtifactTypes, sourceCoverageEvidenceCategories, SourceCoverageEvidenceCategory, SourceCoverageMetadata, SourceCoverageTier, sourceCoverageTiers, assertSeedSourcesWriteAllowed() (+22 more)

### Community 187 - "collection"
Cohesion: 0.26
Nodes (14): asString(), asStringArray(), buildCollectionCounts(), buildDescriptionQuality(), buildDuplicateEntityNames(), buildOpportunityState(), buildReferenceAuditSample(), buildResearchEntityContentPageLeaks() (+6 more)

### Community 188 - "ScrapeRun"
Cohesion: 0.25
...
Cohesion: 0.16
Nodes (29): buildFundingGroupFromCluster(), buildFundingResearchEntityDedupePlan(), buildGroupFromCluster(), buildOfficialLabUrlResearchEntityDedupePlan(), buildProfileAreaShellDuplicateGroup(), buildResearchEntityPiDedupePlan(), canonicalScore(), cleanMergedResearchAreas() (+21 more)
...
Cohesion: 0.11
Nodes (29): StudentVisibilityTier, VisibilityReleaseQueueCollection, visibilityReleaseQueueCollections, visibilityReleaseQueueItemSchema, VisibilityReleaseQueueStatus, visibilityReleaseQueueStatuses, VisibilityRepairStage, visibilityRepairStages (+21 more)

### Community 194 - "AdminListingEditModal.tsx"
Cohesion: 0.24
...
Cohesion: 0.11
Nodes (34): CliOptions, FILTER, main(), parseArgs(), CliOptions, main(), parseArgs(), assertBackfillProgramClassificationsApplyAllowed() (+26 more)
...
Cohesion: 0.06
Nodes (41): categoryColorKeys, Department, DepartmentCodeSystem, departmentSchema, sourceRecordSchema, Fellowship, Grant, grantSchema (+33 more)
...
### Community 202 - "europePmcPaperScraper.ts"
Cohesion: 0.22
Nodes (9): obs(), makeContext(), makeContext(), makeContext(), buildContext(), makeContext(), makeContext(), makeContext() (+1 more)

### Community 203 - "logSanitizer.ts"
Cohesion: 0.06
Nodes (43): BrowseRankBackfillCliOptions, BrowseRankBackfillResult, __dirname, __filename, main(), parseBrowseRankBackfillArgs(), parsePositiveInt(), runBrowseRankBackfill() (+35 more)
...
### Community 213 - "MigratePublicationsToPapers.ts"
Cohesion: 0.22
...
Cohesion: 0.17
Nodes (23): memberObservationsForEntityKey(), csRenderedExtractor(), DepartmentRosterScraper, DeptConfig, entryToResearchEntityObservations(), entryToUserObservations(), fetchRenderedDeptPage(), isLikelyExplicitLabWebsite() (+15 more)
...
### Community 224 - "programService.test.ts"
Cohesion: 0.18
Nodes (10): getFellowshipById(), getFellowshipFilterOptions(), getFilterOptions(), publicFellowshipFilter(), publicFellowshipForStudent(), readAllFellowships(), readFellowship(), getProgramFilterOptions (+2 more)
...
### Community 228 - "securityHeaders.ts"
Cohesion: 0.27
...
### Community 250 - "seedRoutes.test.ts"
Cohesion: 0.21
...
### Community 253 - "OfficialProfilePublicationValue"
Cohesion: 0.22
...
### Community 258 - "classifyDuplicateEntityCluster"
Cohesion: 0.25
...
### Community 268 - "itemOperations.ts"
Cohesion: 0.46
...
Cohesion: 0.11
Nodes (9): asyncHandler(), router, router, router, router, router, router, routeHandlerNames() (+1 more)

### Community 286 - "loadCrossSourceConflictGroups"
Cohesion: 0.60
Nodes (5): loadCrossSourceConflictGroups(), loadObservationsForGroupKey(), observationCollection(), serializeValue(), stringifyId()

### Community 287 - "runStaleObservationConflictReview"
Cohesion: 0.29
...
Cohesion: 0.07
Nodes (41): AccessSignal, accessSignalSchema, ContactRoute, contactRouteSchema, entryPathwaySchema, fieldProvenanceSchema, opennessSignalSchema, recordReviewSchema (+33 more)

## Knowledge Gaps
- **4341 isolated node(s):** `name`, `version`, `private`, `node`, `@emotion/react` (+4336 more)
...
- **Why does `sanitizeLogValue()` connect `sanitizeLogValue` to `departmentRosterScraper.ts`, `initializeConnections`, `labMicrositeDescriptionLLMExtractor.ts`, `entityMaterializer.ts`, `ResearchGroupMember`, `passport.ts`, `undergradFellowshipRecipientScraper.ts`, `duplicateEntityNameReview.ts`, `dedupeResearchEntitiesByPi.ts`, `admin.ts`, `launchAcquisitionReportService.ts`, `profileDataQualityAudit.ts`, `centersInstitutesScraper.ts`, `ScraperContext`, `orcidWorksScraper.ts`, `userService.ts`, `serializedDocumentId`, `researchEntityCoverageAudit.ts`, `sourceHealth.ts`, `renderedFetch.ts`, `officialProfilePiBackfillScraper.test.ts`, `listingService.ts`, `User`, `runReport.ts`, `opportunityDetailService.ts`, `staleObservationConflictReview.ts`, `betaDataQuality.ts`, `listingController.ts`, `analyticsService.ts`, `entryPathwayService.ts`, `yaleCollegeFellowshipsOfficeScraper.ts`, `nsfAwardScraper.ts`, `repairOfficialProfilePublicationPointers.ts`, `postedOpportunityService.ts`, `profileController.ts`, `analytics.ts`, `openAlexPaperScraper.ts`, `labMicrositeUndergradLLMExtractor.ts`, `researchEntityMemberReferenceAudit.ts`, `fellowshipController.ts`, `promoteAcceptedBetaCopy.ts`, `paperAuthorshipAudit.ts`, `backfillResearchDescriptions.ts`, `assertPublicHttpUrl`, `studentDecisionLLMExtractor.ts`, `backfillProfileBiosFromOfficialUrls.ts`, `rebuildPathwaySearchIndex.ts`, `dedupeUsersByIdentity.ts`, `officialProfilePiBackfillScraper.ts`, `repairArchivedEntityArtifacts.ts`, `betaRepairQueue.ts`, `ObservationInput`, `pathwayQualityAudit.ts`, `cli.ts`, `cronRunner.ts`, `snapshotCache.ts`, `scholarlyLinkSuppressionAudit.ts`, `centerAffiliationLLMExtractor.ts`, `materializeEntity`, `launchReviewExceptions.ts`, `acceptedInputs.ts`, `applicationRoutePathwayBackfillCore.ts`, `betaSeedEnvironment.ts`, `types.ts`, `profileBioCoverageAudit.ts`, `launchTrustContract.ts`, `crossSourceObservationConflictReview.ts`, `migrateResearchEntities.ts`, `researchQualitySearchReview.ts`, `migrateResearchEntityCollections.ts`, `researchGroupController.ts`, `disambiguateSurnameLabNames.ts`, `repairDuplicateAccessSignals.ts`, `users.ts`, `programController.ts`, `repairMismatchedPersonEmailsCore.ts`, `Observation`, `studentVisibilityRepairTargets.ts`, `cleanupLegacyMongoCollections.ts`, `seedSources.ts`, `migrateMongoNaming.ts`, `resolveSafeJsonReportOutputPath`, `index.ts`, `userEmailHygiene.ts`, `logSanitizer.ts`, `meiliSyncService.ts`, `repairProfileDescriptionBackfillConflicts.ts`, `clearBetaStudentAnalytics.ts`, `departmentLeadRepairPlanCore.ts`, `auditResearchEntityRename.ts`, `normalizeName`, `backfillPostedOpportunitiesFromListings.ts`, `paperQualityService.ts`, `pathwayRelevanceReview.ts`, `profileImageQualityAudit.ts`, `programs.ts`, `fellowships.ts`, `listings.ts`, `entityMaterializer.test.ts`, `backfillCenterDirectors.ts`, `repairListingResearchEntityProfiles.ts`, `index.ts`, `refreshGateScorecards.ts`, `dedupeExploratoryContactPathways.ts`, `materializePaperObservationsFromRun`, `courseTableService.ts`, `importFaculty.ts`, `errorHandler.ts`, `researchEntity.ts`?**
  _High betweenness centrality (0.065) - this node is a cross-community bridge._
- **Why does `field()` connect `acceptedInputsCore.ts` to `materializeEntity`, `workPlanner.ts`, `initializeConnections`, `profileService.ts`, `ImportRootDataFiles.ts`, `listingClaimRequestService.ts`, `types.ts`, `ResearchGroupMember`, `adminFellowshipsTableReducer.ts`, `crossSourceObservationConflictReview.ts`, `safeHttpUrl`, `orcidWorksScraper.ts`, `sourceHealth.ts`, `User`, `runReport.ts`, `betaDataQuality.ts`, `collection`, `analyticsService.ts`, `entryPathwayService.ts`, `AdminListingsTable.tsx`, `openAlexPaperScraper.ts`, `labMicrositeUndergradLLMExtractor.ts`, `AdminFacultyProfilesTable.tsx`, `promoteAcceptedBetaCopy.ts`, `programService.test.ts`, `dedupeUsersByIdentity.ts`, `officialProfilePiBackfillScraper.ts`, `confidenceResolver.ts`, `buildStaleObservationConflictSummary`, `index.ts`, `visibilityRepairQueueService.ts`?**
  _High betweenness centrality (0.059) - this node is a cross-community bridge._
- **Why does `member()` connect `visibilityRepairQueueService.ts` to `labDetail.tsx`, `centersInstitutesScraper.ts`, `departmentRosterScraper.ts`, `disambiguateSurnameLabNames.ts`, `research-detail-professor-audit.mjs`, `researchEntityQuality.ts`, `researchEntitySearchIndexService.ts`, `researchGroupService.ts`, `profileBioCoverageAudit.ts`, `BackfillV4FacultyMembers.ts`, `studentVisibilityTier.ts`, `researchQualitySearchReview.ts`, `labDetail.ts`?**
