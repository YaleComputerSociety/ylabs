...
## Corpus Check
- 839 files · ~1,312,454 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 11201 nodes · 21488 edges · 3112 communities (912 shown, 2200 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 477 edges (avg confidence: 0.63)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `65d32a8e`
...
## Communities (3112 total, 2200 thin omitted)
...
Cohesion: 0.09
Nodes (26): listing, postMock, renderModal(), renderNavbar(), ResizeObserverMock, ConfigContextType, defaultConfigContext, DepartmentConfig (+18 more)
...
Cohesion: 0.04
Nodes (46): AboutButton(), DepartmentInput(), DepartmentInputProps, AdminRoute(), AdminRouteProps, getLocalAdminDevLoginUrl(), getSafeLocalAdminRedirectTarget(), AnalyticsButton() (+38 more)
...
Cohesion: 0.03
Nodes (83): AdminFellowshipEditModal(), Props, mockedAxios, fellowship, renderModal(), CourseTableCourse, CourseTableSection(), CourseTableSectionProps (+75 more)
...
Cohesion: 0.07
Nodes (46): ProfileEditor(), ProfileEditorProps, orcidHref(), ProfileHeader(), ProfileHeaderProps, profileLinkDedupeKey(), profileUrlLinks(), shouldHideBroadSchoolLabel() (+38 more)
...
Cohesion: 0.06
Nodes (50): BETA_CHECK_OPERATOR_METADATA, betaCommand(), BetaDataQualityCheck, BetaDataQualityDiagnostics, BetaDataQualityOptions, BetaDataQualityProgressEvent, BetaDataQualitySeverity, BetaDataQualitySummary (+42 more)
...
Cohesion: 0.07
Nodes (61): AcceptedInputIssue, AcceptedInputUser, applyOrcidCrosswalkCsv(), applyScholarAcceptedCsv(), ArxivResolvedTarget, ArxivValidationResult, buildAcceptedInputsStatus(), buildArxivCandidateRows() (+53 more)
...
Cohesion: 0.11
Nodes (27): CompensationType, EntryPathwayStatus, EntryPathwayType, EvidenceStrength, PostedOpportunityStatus, DerivedEntryPathway, RouteClassification, AccessArtifactCandidate (+19 more)
...
Cohesion: 0.07
Nodes (46): allowedValues(), hasOversizedStringList(), isOversizedSearchRequest(), parseFilters(), parseSearchInput(), parseSort(), publicPathwayResearchEntity(), publicPathwaySearchResult() (+38 more)
...
Cohesion: 0.06
Nodes (47): ListingEditor(), ListingEditorProps, VennDiagramToggle(), VennDiagramToggleProps, CombinedFilterDropdown(), CombinedFilterDropdownProps, FilterTabConfig, ListingDetailModal() (+39 more)
...
Cohesion: 0.17
Nodes (22): assertSafeAcceptedInputPathText(), defaultAdvisorResolver(), resolveSafeAcceptedInputPath(), resolveSafeAcceptedInputRoot(), assertAcceptedInputsApplyAllowed(), buildAcceptedInputsOutput(), CliOptions, COMMANDS_REQUIRING_DB (+14 more)
...
Cohesion: 0.24
Nodes (15): asString(), asStringArray(), buildCollectionCounts(), buildDescriptionQuality(), buildDuplicateEntityNames(), buildOpportunityState(), buildReferenceAuditSample(), buildResearchEntityContentPageLeaks() (+7 more)
...
Cohesion: 0.10
Nodes (25): fieldColorKeys, ResearchArea, researchAreaSchema, ResearchField, buildDeploymentFingerprint(), ConfigData, DeploymentEnv, DeploymentEnvKey (+17 more)
...
## Knowledge Gaps
- **4343 isolated node(s):** `name`, `version`, `private`, `node`, `@emotion/react` (+4338 more)
